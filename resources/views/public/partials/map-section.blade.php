<div x-data="{
    ...
    <section id="peta" class="py-24 bg-gradient-to-br from-blue-300 via-white to-descan-700">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                ...
                {{-- <span
                    class="inline-flex items-center px-4 py-2 rounded-full bg-slate-100 text-blue-700 text-sm font-semibold">
            ...
            <div class="grid lg:grid-cols-12 gap-6 mt-6">
                ...
                <div class="lg:col-span-4">
                    ...
                    <div x-on:show-location.window="selected = $event.detail"
                        class="bg-white rounded-3xl border border-slate-200 shadow-lg p-6 lg:sticky lg:top-24">
