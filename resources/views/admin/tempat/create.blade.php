...
<div class="max-w-5xl mx-auto space-y-8">
    ...
    <div class="flex items-start justify-between flex-wrap gap-4">
        ...
        <div>
            ...
            <p class="text-slate-500 mt-2">
                Input data lokasi, sektor, dan titik koordinat wilayah
            </p>
        </div>
    ...
    <form method="POST"
        ...
        <div class="p-8 space-y-10">
            ...
            <section class="space-y-6">
                ...
                <div id="ekonomi-fields"
                     class="hidden bg-blue-50 border border-blue-100 rounded-2xl p-6 space-y-5">
            ...
            <section class="space-y-6">
                ...
                <div id="gps-status"
                     class="text-sm text-blue-600 font-medium"></div>
        ...
        <div class="border-t border-slate-100 px-8 py-5 bg-slate-50 flex items-center justify-end gap-4">
            ...
            <button class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-2xl font-semibold shadow-lg shadow-blue-100 transition">
                Simpan Data
            </button>
