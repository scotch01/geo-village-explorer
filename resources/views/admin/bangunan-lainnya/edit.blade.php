    ...
    <div class="max-w-5xl mx-auto space-y-10 animate-fade-in px-2 sm:px-0">
        ...
        <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 lg:p-8">
            ...
            <h1 class="text-2xl lg:text-3xl font-black text-slate-900 tracking-tight">
                ...
                Edit Data BLOK TAMBAHAN

            </h1>

            <p class="text-sm lg:text-base font-medium text-slate-700 mt-1">

                Perbarui data bangunan lainnya di bawah ini.
        ...
        <form method="POST" action="{{ route('admin.bangunan-lainnya.update', $tempat) }}" class="space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="nama_infrastruktur"
                            value="{{ old('nama_infrastruktur', $bangunanLainnya->nama_infrastruktur) }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="kategori"
                            ...
                            @foreach ($kategori as $key => $label)
                                <option value="{{ $key }}" @selected(old('kategori', $bangunanLainnya->kategori) == $key)>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="provinsi"
                                    value="{{ old('provinsi', $bangunanLainnya->provinsi) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="kabupaten"
                                    value="{{ old('kabupaten', $bangunanLainnya->kabupaten) }}"
                                    class="w-full rounded-2xl border-slate-200 bg-slate-100 p-3.5 font-semibold text-slate-500">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="kecamatan"
                                    value="{{ old('kecamatan', $bangunanLainnya->kecamatan) }}"
                                    class="w-full rounded-2xl border-slate-200 bg-slate-100 p-3.5 font-semibold text-slate-500">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="desa" value="{{ old('desa', $bangunanLainnya->desa) }}"
                                    class="w-full rounded-2xl border-slate-200 bg-slate-100 p-3.5 font-semibold text-slate-500">
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="dusun"
                                    ...
                                    @foreach ($dusuns as $dusun)
                                        <option value="{{ $dusun }}" @selected(old('dusun', $bangunanLainnya->dusun) == $dusun)>
                                            {{ $dusun }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="md:col-span-2 space-y-2">
                                ...
                                <textarea name="alamat" rows="3"
                                    class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-4 font-semibold text-slate-800 focus:border-blue-500 focus:ring focus:ring-blue-200/50">{{ old('alamat', $bangunanLainnya->alamat) }}</textarea>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="email" name="email" value="{{ old('email', $bangunanLainnya->email) }}"
                            class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-800 focus:border-blue-500 focus:ring focus:ring-blue-200/50">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="website" value="{{ old('website', $bangunanLainnya->website) }}"
                            placeholder="https://"
                            class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-800 focus:border-blue-500 focus:ring focus:ring-blue-200/50">
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 lg:p-8 transition-all">
                ...
                <div class="space-y-8">
                    ...
                    <x-geo-location latitude-field="latitude" longitude-field="longitude" accuracy-field="akurasi"
                        :latitude-value="$bangunanLainnya->latitude" :longitude-value="$bangunanLainnya->longitude" :accuracy-value="$bangunanLainnya->akurasi" />
                    ...
                    <div class="flex items-center justify-end gap-3 border-t-2 border-gray-300 pt-4">
                        ...
                        <button type="submit"
                            class="px-6 py-3.5 bg-amber-500 hover:bg-amber-600 text-white rounded-2xl font-bold transition-all active:scale-95 shadow-md shadow-blue-600/20 text-sm">
