...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <x-back-button :href="route('admin.portal-item.index')">
            Kembali
        </x-back-button>
                                ...
                                <tr class="hover:bg-slate-50 transition">
                                    ...
                                    <td class="px-6 py-5">
                                        ...
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <a href="{{ route('admin.portal-category.edit', $category) }}"
                                            ...
                                            <form action="{{ route('admin.portal-category.destroy', $category) }}"
