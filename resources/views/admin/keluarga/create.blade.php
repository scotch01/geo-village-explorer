...
@section('content')
    <div class="max-w-5xl mx-auto space-y-10 animate-fade-in px-2 sm:px-0">
        ...
        <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 lg:p-8">
            ...
            <p class="text-sm lg:text-base font-medium text-slate-700 mt-1">Silakan lengkapi kuisioner keluarga dan perumahan di bawah ini secara teliti.</p>
        </div>

        <div x-data="keluargaForm()">

            <form method="POST" x-ref="keluargaForm" action="{{ route('admin.keluarga.store', $tempat) }}" class="space-y-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nik_kepala_keluarga" value="{{ old('nik_kepala_keluarga') }}"
                                maxlength="16" class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-800 transition-all focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-sm lg:text-base tracking-wider">
                        </div>
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 lg:p-8 transition-all">
                    ...
                    <div class="flex items-center gap-3 mb-6 border-b border-slate-100 pb-4">
                        <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-slate-100 text-slate-700 font-bold text-sm">3</span>
                            ...
                            <div class="flex flex-wrap gap-6 items-center">
                                @foreach ($yaTidak as $key => $label)
                                    <label class="inline-flex items-center gap-3 cursor-pointer group">
                                        ...
                                        <span class="text-sm lg:text-base font-semibold text-slate-600 group-hover:text-slate-900 transition-colors">
                                            {{ $label }}
                                        </span>
                                    </label>
                                @endforeach
                ...
                <div class="bg-blue-50/60 border border-blue-100 rounded-3xl p-6 lg:p-8 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 transition-all">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-blue-700/90 mt-0.5">
                                Pertanyaan nomor 5–18 diisi secara detail melalui modul entri anggota keluarga setelah baris data ini tersimpan.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 border-b border-slate-50 pb-6">
                            <div class="space-y-2">
                                ...
                                <div class="relative max-w-xs">
                                    <input type="number" min="1" name="jumlah_keluarga_dalam_rumah"
                                        ...
                                        class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-800 transition-all focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-sm lg:text-base">
                                    <span class="absolute right-4 top-3.5 text-slate-400 text-sm font-semibold mr-5">Keluarga</span>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="status_kepemilikan_rumah" class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-700 transition-all focus:border-blue-500 text-sm lg:text-base cursor-pointer">
                                    <option value="" class="text-slate-400 font-medium">-- Pilih Status Kepemilikan --</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 border-b border-slate-50 pb-6">
                            <div class="space-y-2">
                                ...
                                <div class="relative max-w-xs">
                                    <input type="number" min="1" name="luas_lantai"
                                        ...
                                        class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-800 transition-all focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-sm lg:text-base">
                                    <span class="absolute right-4 top-3.5 text-slate-400 text-sm font-semibold mr-5">m²</span>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="bahan_lantai" class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-700 transition-all focus:border-blue-500 text-sm lg:text-base cursor-pointer">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-2">
                            <div class="space-y-2">
                                ...
                                <select name="bahan_dinding" class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-700 transition-all focus:border-blue-500 text-sm lg:text-base cursor-pointer">
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="bahan_atap" class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-700 transition-all focus:border-blue-500 text-sm lg:text-base cursor-pointer">
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 lg:p-8 transition-all">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2 md:col-span-2 border-b border-slate-50 pb-4">
                            ...
                            <select name="fasilitas_bab" x-model="fasilitasBab" class="w-full md:w-2/3 rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-700 transition-all focus:border-blue-500 text-sm lg:text-base cursor-pointer">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="jenis_kloset" x-ref="jenisKloset" :disabled="fasilitasBab == 6"
                                :class="{'bg-slate-100 text-slate-400 cursor-not-allowed border-slate-200/60': fasilitasBab == 6}"
                        ...
                        <div class="space-y-2 pt-2">
                            ...
                            <select name="sumber_air_minum" class="w-full rounded-2xl border-slate-200 bg-slate-50/50 p-3.5 font-semibold text-slate-700 transition-all focus:border-blue-500 text-sm lg:text-base cursor-pointer">
                        ...
                        <div x-show="sumberPenerangan == '1'" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95"
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                <div>
                                    <h3 class="font-bold text-slate-800 text-sm lg:text-base tracking-tight">
                                        31a. Jika listrik PLN dengan meteran, berapa jumlah meteran listrik yang terpasang di rumah ini?
                                    </h3>
                                ...
                                <button type="button"
                                    @click="meterans.push({ daya_listrik: '' })"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <template x-for="(meteran, index) in meterans" :key="index">
                                    <div class="bg-white border border-slate-200 shadow-sm rounded-xl p-4 relative space-y-3">
                                        <div class="flex items-center justify-between">
                                            <span class="text-xs font-bold uppercase tracking-wider text-slate-400" x-text="'Meteran #' + (index + 1)"></span>
                            ...
                            <div x-show="meterans.length === 0" class="text-center py-6 border border-dashed border-slate-200 rounded-xl text-slate-400 font-medium text-sm">
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 lg:p-8 transition-all">
                    <div class="space-y-8">
                        ...
                        <div class="space-y-4">
                            <label class="block text-sm lg:text-base font-bold text-slate-800 tracking-tight">
                                32. Apakah ada minimal salah satu anggota keluarga ini yang menerima kredit dari lembaga keuangan berikut dalam setahun terakhir?
                            </label>

                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-3xl">
                                @foreach ($kreditSumber as $key => $label)
                                    <label class="flex items-center gap-3 p-3 rounded-2xl border border-slate-100 hover:border-slate-200 bg-slate-50/30 hover:bg-slate-50 cursor-pointer transition-all group">
                                        <input type="checkbox" class="exclusive-checkbox w-5 h-5 text-blue-600 border-slate-300 rounded focus:ring-blue-500 focus:ring-opacity-50" 
                                            data-group="kredit_sumber" data-exclusive="{{ $key === 'X' ? '1' : '0' }}" name="kredit_sumber[]"
                        ...
                        <div class="space-y-4 border-t border-slate-100 pt-6">
                            <label class="block text-sm lg:text-base font-bold text-slate-800 tracking-tight">
                                33. Apakah dalam setahun terakhir keluarga ini pernah menerima kredit dari lembaga keuangan dan untuk apa?
                            </label>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-3xl">
                                @foreach ($kreditTujuan as $key => $label)
                                    <label class="flex items-center gap-3 p-3 rounded-2xl border border-slate-100 hover:border-slate-200 bg-slate-50/30 hover:bg-slate-50 cursor-pointer transition-all group">
                                        <input type="checkbox" class="exclusive-checkbox w-5 h-5 text-blue-600 border-slate-300 rounded focus:ring-blue-500 focus:ring-opacity-50" 
                                            data-group="kredit_tujuan" data-exclusive="{{ $key === 'X' ? '1' : '0' }}" name="kredit_tujuan[]"
                ...
                <div class="flex items-center justify-end border-t border-slate-200/60 pt-6">
                    <button type="submit" @click="redirectTo = 'survey'"
                        class="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-bold transition-all active:scale-95 shadow-md shadow-blue-600/20 text-sm lg:text-base text-center">
            ...
            <div x-show="showAnggotaModal" x-cloak x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-end="opacity-0"
                class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4">

                <div @click.away="showAnggotaModal = false" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95"
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm font-semibold text-slate-500 leading-relaxed">
                            Data instrumen induk keluarga akan disimpan terlebih dahulu ke dalam sistem, kemudian Anda otomatis dialihkan menuju halaman entri data anggota keluarga.
                        </p>
                    </div>
        ...
        <script>
            ...
            document.querySelectorAll('.exclusive-checkbox').forEach(checkbox => {
                checkbox.addEventListener('change', function() {
                    ...
                    if (this.checked) {
                        document.querySelectorAll(`.exclusive-checkbox[data-group="${groupName}"]`).forEach(sibling => {
                            if (sibling !== this) {
